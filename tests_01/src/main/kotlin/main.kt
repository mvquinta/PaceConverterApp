...
fun main(args: Array<String>) {
   ...
   var timeScnd: Int = 23*/
    ...
    fun paceGivenSpeed(kmPerHr: Double) {
        val finalPace: Double = ((60.0 / kmPerHr) * 0.60)
        println("Your pace was: ${finalPace}")
    }

    fun speedGivenPace(timMin: Int, timeScnd: Int) {
        val scndToHr = timeScnd / 3600
        val minToHr = timMin / 60
        val finalSpeed:Double = (scndToHr + minToHr)
    }
